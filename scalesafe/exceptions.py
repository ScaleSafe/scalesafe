...
class ScaleSafeTokenError(ScaleSafeException):
    ...
    def __init__(self, message="Something looks wrong with your ScaleSafe API Key. Check your object's api_key variable or on your account at app.scalesafe.ai."):
...
class BannedLocationError(OutOfComplianceError):
    ...
    def __init__(self, message="This location is banned or not allowed for operations."):
        super().__init__(message)
...
class APIRateLimitExceededError(ScaleSafeException):
    ...
    def __init__(self, message="API rate limit has been exceeded. Please wait before making more requests."):
        super().__init__(message)

class DataValidationError(ScaleSafeException):
    """Exception raised for data validation errors."""
    def __init__(self, message="Data validation error: missing or incorrect fields. Please ensure all required fields are correctly formatted."):
        super().__init__(message)

class DatabaseOperationError(ScaleSafeException):
    """Exception raised for Firestore operation failures."""
    def __init__(self, message="A database operation failed. Please try again or contact support if the issue persists."):
        super().__init__(message)

class UnauthorizedAccessError(ScaleSafeException):
    """Exception raised for unauthorized access attempts."""
    def __init__(self, message="Unauthorized access attempt detected. Ensure you have the correct permissions."):
        super().__init__(message)

class ResourceNotFoundError(ScaleSafeException):
    """Exception raised when a requested resource is not found."""
    def __init__(self, message="The requested resource was not found. Verify the resource ID or contact support if the issue persists."):
        super().__init__(message)
